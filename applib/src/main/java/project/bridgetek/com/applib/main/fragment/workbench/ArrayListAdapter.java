...
public class ArrayListAdapter<T> extends BaseAdapter implements Filterable {
    /**
     * Contains the list of objects that represent the data of this ArrayListAdapter.
    ...
    private View createViewFromResource(int position, View convertView, ViewGroup parent,
        ...
        try {
            ...
            Log.e("ArrayListAdapter", "You must supply a resource ID for a TextView");
            throw new IllegalStateException(
                    "ArrayListAdapter requires the resource ID to be a TextView", e);
        }
    ...
    /**
     * Creates a new ArrayListAdapter from external resources. The content of the array is
     * obtained through {@link android.content.res.Resources#getTextArray(int)}.
     *
     * @param context        The application's environment.
     * @param textArrayResId The identifier of the array to use as the data source.
     * @param textViewResId  The identifier of the layout used to create views.
     * @return An ArrayListAdapter<CharSequence>.
     */
