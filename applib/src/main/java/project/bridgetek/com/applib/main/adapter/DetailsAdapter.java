...
public class DetailsAdapter extends RecyclerView.Adapter<RoomViewHolder> {
    private Activity mContext;
    private List<ResultFileInfo> mList;
    AudioPlayer audioPlayer = AudioPlayer.instance();

    public DetailsAdapter(Activity mContext, List<ResultFileInfo> mList) {
    ...
    public void onBindViewHolder(@NonNull RoomViewHolder holder, int position) {
        ...
        if (s.getFileType() == CountString.CORD || s.getFileType().equals(CountString.CORD)) {
            ...
            Glide.with(mContext).load(file).into(holder.imgAbnormal);
        }
