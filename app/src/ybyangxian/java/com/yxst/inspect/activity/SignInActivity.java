...
import com.yxst.inspect.util.WiFiUtil;
...
public class SignInActivity extends AppCompatActivity {
    //登录账号、密码
    @BindView(R.id.edit_sign_in_account) TextInputEditText mAccount = null;
    @BindView(R.id.edit_sign_in_password) TextInputEditText mPassword = null;
    //登录按钮
    @BindView(R.id.btn_sign_in) AppCompatButton mSignIn = null;
