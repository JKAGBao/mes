...
import com.yxst.inspect.rx.RxRestService;
...
//        File tempFile = new File(dir, "/DCIM/Camera/IMG_20190609_130548.jpg");
        ...
        HttpTransportSE se = new HttpTransportSE(MyApplication.WSDL_URI);
    ...
    public static String getImagePath() throws Exception{
        ...
        HttpTransportSE httpTransportSE = new HttpTransportSE(MyApplication.WSDL_URI);
