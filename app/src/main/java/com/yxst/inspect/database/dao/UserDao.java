...
public class UserDao extends AbstractDao<User, Long> {
    ...
    public static class Properties {
        ...
        public final static Property RoleNameCN = new Property(4, String.class, "RoleNameCN", false, "ROLE_NAME_CN");
        ...
        public final static Property HeadImg = new Property(7, String.class, "HeadImg", false, "HEAD_IMG");
        public final static Property DeptID = new Property(8, int.class, "DeptID", false, "DEPT_ID");
    }
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"user\" (" + //
                ...
                "\"ROLE_NAME_CN\" TEXT," + // 4: RoleNameCN
                "\"REAL_NAME\" TEXT," + // 5: RealName
                "\"DEPT_NAME\" TEXT," + // 6: DeptName
                "\"HEAD_IMG\" TEXT," + // 7: HeadImg
                "\"DEPT_ID\" INTEGER NOT NULL );"); // 8: DeptID
    }
    ...
    protected final void bindValues(DatabaseStatement stmt, User entity) {
        ...
        String RoleNameCN = entity.getRoleNameCN();
        if (RoleNameCN != null) {
            stmt.bindString(5, RoleNameCN);
        }
        ...
        stmt.bindLong(9, entity.getDeptID());
    }
    ...
    public User readEntity(Cursor cursor, int offset) {
        User entity = new User( //
            ...
            cursor.isNull(offset + 4) ? null : cursor.getString(offset + 4), // RoleNameCN
    ...
    public void readEntity(Cursor cursor, User entity, int offset) {
        ...
        entity.setRoleNameCN(cursor.isNull(offset + 4) ? null : cursor.getString(offset + 4));
        ...
        entity.setDeptID(cursor.getInt(offset + 8));
     }
