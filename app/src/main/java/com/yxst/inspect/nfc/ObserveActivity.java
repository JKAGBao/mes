...
public class ObserveActivity extends BaseActivity {
    ...
    @BindView(R.id.radioGroup_gender)RadioGroup radio;
    @BindView(R.id.rb_no)RadioButton no;
    @BindView(R.id.rb_yes)RadioButton yes;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_inspect_observe);
...
//                finish();
        ...
        gridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View v, int position, long id) {
                if (imageItem.size() == 10) { //第一张为默认图片
                    Toast.makeText(ObserveActivity.this, "图片数9张已满", Toast.LENGTH_SHORT).show();
           ...
           //         Toast.makeText(ObserveActivity.this, "添加图片", Toast.LENGTH_SHORT).show();
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {//7.0及以上
                        if (ContextCompat.checkSelfPermission(ObserveActivity.this,
                                Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED) {
                                ActivityCompat.requestPermissions(ObserveActivity.this,
    ...
    private void saveValue(){
        ...
        //保存item
        Item itemUpdate = ItemQueryUtil.getItemById(this,itemId,lineId);
        itemUpdate.setCheckValue(checkValue);
        itemUpdate.setCheckStatus(ConfigInfo.ITME_CHECKED_STATUS);
        ItemQueryUtil.updateItem(itemUpdate);
        ...
        if(itemList.size()!=0){
            ...
            switch (checkType){
                ...
                case(ConfigInfo.ITME_TYPE_TEMPERATURE):
                    Intent intent = new Intent(ObserveActivity.this,MainActivity.class);
                ...
                case (ConfigInfo.ITME_TYPE_OBSERVE):
                    intent = new Intent(ObserveActivity.this,ObserveActivity.class);
                    intent.putExtra("itemId",localItem.getItemID());
                    intent.putExtra("lineId",localItem.getLineID());
                    intent.putExtra("placeId",localItem.getPlaceID());
                    intent.putExtra("name",placeName);
    ...
    private void saveRecordImage() throws Exception {
        ...
        InspectImageManager.postInpsectImageToServer(ObserveActivity.this,imageList);
    ...
    private void recordSave(Record record, Item item) {
        ...
        records.add(record);
        RecordManager.realPostRecord(ObserveActivity.this,records);
    }
    /*
     * Dialog对话框提示用户删除操作
     * position为删除图片位置
                            ...
                            case 0:
                                ...
                                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N){
                                    if (intent.resolveActivity(getPackageManager()) != null){
                                        ...
                                        imgUri = FileProvider.getUriForFile(ObserveActivity.this,
