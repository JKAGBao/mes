...
public class SettingAdapter extends  RecyclerView.Adapter<SettingAdapter.ViewHolder> {
    ...
    public SettingAdapter(Context context, List<LubeItem> items){
...
//        holder.tvProgress1.setText(finishItems.size()+"");
        holder.llAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mOnItemClickListener.onClick(holder.llAdd,item.getZoneID(),position);
            }
        });
    ...
    public interface OnItemClickListener {
        void onClick(View view, Long lineId, int position);
    }
