 ...
 */
public class DeviceAdapter extends RecyclerView.Adapter<DeviceAdapter.RvViewHolder> {
    ...
    public DeviceAdapter(List<InspectDevice> data) {
        this.data = data;
    }
    public DeviceAdapter(Context context, List<InspectDevice> data) {
    ...
    public RvViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.adapter_rv_device,viewGroup,false);
        RvViewHolder holder = new DeviceAdapter.RvViewHolder(view);
        return holder;
    }
