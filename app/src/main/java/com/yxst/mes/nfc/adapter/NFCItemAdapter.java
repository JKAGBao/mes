...
public class NFCItemAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ItemValue value = ItemValueQueryUtil.getItemValueByItemId(context,item.getItemID(),item.getLineID());
        holder.tvCheckValue.setText(value==null?"":value.getCheckValue());
