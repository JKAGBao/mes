...
/** 
 * DAO for table "UN_LUBE".
*/
public class UnLubeDao extends AbstractDao<UnLube, Long> {

    public static final String TABLENAME = "UN_LUBE";

    /**
     * Properties of entity UnLube.<br/>
    ...
    public UnLubeDao(DaoConfig config) {
        super(config);
    }
    
    public UnLubeDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"UN_LUBE\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"UN_LUBE\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, UnLube entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, UnLube entity) {
        stmt.clearBindings();
    ...
    @Override
    public UnLube readEntity(Cursor cursor, int offset) {
        UnLube entity = new UnLube( //
    ...
    @Override
    public void readEntity(Cursor cursor, UnLube entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(UnLube entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(UnLube entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(UnLube entity) {
