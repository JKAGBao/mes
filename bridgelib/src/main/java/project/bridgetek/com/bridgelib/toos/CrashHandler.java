...
public final class CrashHandler {
    ...
    public static void init(final String crashDirPath, final OnCrashListener onCrashListener) {
        ...
        if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())
            ...
            defaultDir = HiApplication.getApplication().getExternalCacheDir() + FILE_SEP + "crash" + FILE_SEP;
        else {
            defaultDir = HiApplication.getApplication().getCacheDir() + FILE_SEP + "crash" + FILE_SEP;
        }
