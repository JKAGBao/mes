...
import project.bridgetek.com.bridgelib.loader.BlackLoader;
...
import project.bridgetek.com.bridgelib.net.callback.RequestCallbacks;
import project.bridgetek.com.bridgelib.net.download.DownloadHandler;
...
public class RestClient {
    ...
    private void request(HttpMethod method) {
        ...
        if (LOADER_STYLE != null) {
            BlackLoader.showLoading(CONTEXT, LOADER_STYLE);
        }
