...
public class DeployableRegularTextView extends AppCompatTextView {
    private Drawable mDrawable; // 显示的图
    private int mDropDrawableResId; // 下拉图标
    private int mRiseDrawableResID; // 上拉图标
    private int mork = 0;

    public DeployableRegularTextView(Context context) {
        super(context);
        init(context);
    }

    public DeployableRegularTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public DeployableRegularTextView(Context context, AttributeSet attrs, int defStyleAttr) {
