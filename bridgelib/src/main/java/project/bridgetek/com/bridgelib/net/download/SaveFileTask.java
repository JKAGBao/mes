package project.bridgetek.com.bridgelib.net.download;
...
import project.bridgetek.com.bridgelib.utils.FileUtil;

/**
 * Created by warming 2018/2/28.
 */
...
public class SaveFileTask extends AsyncTask<Object, Void, File> {
    ...
    private void autoInstallApk(File file) {
        if (FileUtil.getExtension(file.getPath()).equals("apk")) {
            ...
            Black.getApplicationContext().startActivity(install);
        }
    }
}
